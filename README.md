...
| `memory_satiration` | 0.7| `float` | If compute batch is set to `"auto"`, this ratio will be used to estimate a compute batch that would requiere "memory_satiration" of the avalible GPU memory. |
